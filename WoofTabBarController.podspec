#
#  Be sure to run `pod spec lint WooftabBarController.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Hassan Ahmed Khan" => "hassandotahmed@gmail.com" }
  spec.social_media_url   = "https://twitter.com/hassandotahmed"
  ...
  spec.source       = { :git => "https://github.com/ihak/WooftabBarController.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "WoofTabBarController/WoofTabBarController/**/*.swift"
